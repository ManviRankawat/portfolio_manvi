...
import VendorPayment from "../assets/VendorPaymentAnalytics.png";
...
const projects = [
  ...
  {
    title: "Vendor Payment Analytics",
    description: "Vendor Payments Analytics Dashboard, with RAG based AI assistant chatbot",
    techStack: ["React","NodeJS", "Express", "PostgreSQL"],
    image: VendorPayment,
    link: "https://github.com/ManviRankawat/GoldenAnalytics",
  },
  {
